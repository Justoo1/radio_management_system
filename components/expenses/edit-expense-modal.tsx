...
import type { ExpenseResponse } from '@/app/actions/expenses'
...
export default function EditExpenseModal({ expense, onOpenChange, onSuccess }: EditExpenseModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload: UpdateExpenseInput = {
        ...
        status: (formData.status as 'RECORDED' | 'APPROVED' | 'PAID' | 'CANCELLED') || undefined,
      }
